...
SUITES = [
    ...
    },
    {
        ...
        "note":  [
            "================================================================",
            "  QA FulFillment - Coleccion APIM vs QA OnnetFibra",
            "  Ejecuta el flujo de activacion real via Axway API Management",
            "  en ambiente QA contra OLTs de laboratorio.",
            "  VNO-00 TCH · VNO-02 KAO · VNO-03 B1/Entel · VNO-05 DTV",
            "  Fase 1 — Provisioning : Factibilidad + Asignacion + Activacion",
            "  Fase 2 — Operaciones  : DevMod + Modificacion",
            "  Fase 3 — Baja         : CancelOrdenServicio + Unsubscription",
            "  URL: https://eqapi.onnetfibra.cl",
            "================================================================",
        ],
        "cmd": None, "cwd": None, "report": None, "requires": None,
    ...
    },
    {
        ...
        "note":  [
            "================================================================",
            "  QA Consultas - Endpoints de consulta y diagnostico",
            "  ConsultaDataONT, RetrieveAccess (TCH/KAO),",
            "  DiagnosticoAcceso, AccessStateResponse,",
            "  EstadoVecino, FiberChange.",
            "  URL: https://eqapi.onnetfibra.cl",
            "================================================================",
        ],
        "cmd":   [NEWMAN, "run",
